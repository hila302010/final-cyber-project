...
# Your GitHub token
GITHUB_TOKEN = "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"
    ...
    while True:
        ...
        try:
            ...
            with ThreadPoolExecutor(max_workers=MAX_THREADS) as executor:
                futures = {executor.submit(process_file, item, domain, 
                                           email_urls, checked_urls): item for item in
                           results["items"]}
...
if __name__ == "__main__":
    ...
    write_to_file(f"{domain_name}_github_results.txt", found_emails)